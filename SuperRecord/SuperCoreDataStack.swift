...
//    }
//    
    public static let inMemoryStack = SuperCoreDataStack(storeType:NSInMemoryStoreType,storeURL:nil)
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
      ...
      //  let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent(storeName)
        ...
        let failureDescription = "Failed to initialize the application's saved data"
        do {
            ...
            let dict: [NSObject : AnyObject] = [NSLocalizedDescriptionKey : failureDescription, NSLocalizedFailureReasonErrorKey : failureReason, NSUnderlyingErrorKey : error!]
